...
public struct Post {
    ...
    public init(author: String, description: String = "", image: String = "", likes: Int = 0, views: Int = 0, id: UUID) {
        self.author = author
